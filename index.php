...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@MACS.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9970631208</li>
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">MACS<p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MAC'S</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our MAC'S</h3>
						   <p class="about-para-w3ls">We Provide best of best services with affordable prices.So book now</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>you are in for a Great Treat. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Best services and the view from there  is OMG!!!</p>
								<h5>Sneha Joy</h5>
								<p>Delhi</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/sur.png" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>Top class staff and ambience is very good.</p>
								<h5>Suresh Jha</h5>
								<p>Bihar</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Visit with your family the services they provide are very good and the staff is very friendly .</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9970631208</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@MAC'S.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Kalmunai Road, Batticaloa, Lonavla</p>
			...
			<div class="col-xl-5 align-self-center m-auto map" style="margin-bottom:15px;"><iframe class="justify-content-center align-self-center" allowfullscreen="" frameborder="0" width="80%" height="200" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBK2og4vbNEBiMmh3w2O4qDKsAe-goqfcg&amp;q=lonavala%2Cpune&amp;zoom=11"></iframe></div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 MAC'S . All Rights Reserved | Design by <a href="index.php">MAC'S</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
